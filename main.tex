...
\usepackage{isabelle/comment}
\usepackage{isabelle/isabellesym}
\usepackage{isabelle/isabelletags}
\usepackage{isabelle/pdfsetup}
\usepackage{isabelle/railsetup}
...
and \texttt{axiom} statements that may use quantifiers.
...
If we wish to extend the locale to other theory files, we use the \texttt{context} command:
...
Because map type constructors use the same VC encoding mechanisms as abstract value constructors under the polymorphic type encoding,
