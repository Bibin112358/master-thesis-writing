...
Additionally, I want to thank Prof. Dr. Ralf Jung for teaching the course Formal Foundations of Programming Languages.
His instruction on the formal semantics of programming languages and the interactive theorem prover Coq (now Rocq) helped me find my footing much faster in this project.
I also wish to thank Kevin Buzzard and Mohammad Pedramfar for developing "The Natural Number Game,"
which introduced me to Lean and the world of theorem provers.
