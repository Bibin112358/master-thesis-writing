...
certified verification runs for programs utilizing maps, demonstrating the soundness of our approach. 
...
I wish to express my biggest gratitude to Yushuo Xiao.
First, for advertising this thesis project and accepting me as his student.
Working on a project involving project verification and interactive theorem provers ("proof assistants")
as been a delight.
I always enjoyed our weekly meeting, sharing my progres
and getting valuable directions, feedback,
a chance for reﬂection, encouragements, help with the technologies,
especially Isabelle/HOL and debugging help.
I would have not come far without his guidance.
Another big thank you goes to Prof. Dr. Peter Müller,
for letting me work on such an interesting project in his research group,
asking interesting questions during my presentations,
supervising the prior work by Dr. Parthasarathy Gaurav,
on which this project is built upon,
and teaching interesting courses such as Program Verification.
Also, I want to thank Prof. Dr. Ralf Jung for teaching the course
Formal Foundations of Programming Languages,
teaching formal semantics of programming languages
and the interactive theorem prover Coq (now Rocq),
which has helper finding my footing faster for this project.
Next I want to thank Kevin Buzzard and Mohammad Pedramfar for building
"The Natural Number Game" introducing me to LEAN and theorem provers in general.

I want to thank my friends, Ivana Klasovitá,
for being a long-time friend and being someone to talk to.
Also, thanks to my friend Remo Spichtig for being someone to always have interesting conversations with
and inviting me to his board game evenings.
Also, I want to thank Kwok Wai Lui for our exchange of snacks and rants,
whene working next to each other for our thesises.

Next, I want to thank the sport of Volleyball, and everyone who enables me to play it,
including the ASVZ and VBC Rämi.
Having something else other than my project, physically exerting, sociable and learning team work
is a good change to academic work.
Also, thanks for the Swiss Informatics and Mathematical Olympiad,
for deepening my interest in these topics,
and giving me the opportunity to flexibly volunteer there to contriubute back.

Last but not least, I want to thank my family, for encouraging me to study well
and supporting me financially throughout.
