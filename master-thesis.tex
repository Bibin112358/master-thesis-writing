...
\begin{verbatim}
  - consistency with other type encodings
  - undesired behaviour, specifying something that is not defined?
\end{verbatim}
...
\ref{sec:vc-structure}

\begin{verbatim}
  - maps significantly change the VC
  - especially polymorphic type encoding
  - map axioms
\end{verbatim}
...
\begin{verbatim}
- implication, need to fulfill LHS to use conclusion (WP)
- the LHS also newly contains map axioms, we need to fulfill
- this also gives us formal goals our map semantics need to fulfill
\end{verbatim}

\begin{verbatim}
[TODO have SMT map axiom example in appendix, and just list simplified version here?]

need
- values
- types
- type: value => types
- MapType0Store (v, v, v) => v
- MapType0Select (v, v) => v
- MapType0Type (t, t) => t
- MapType0TypeInv0 t => t
- MapType0TypeInv1 t => t

axioms
- (MapType0TypeInv0 (MapType0Type
- (MapType0TypeInv1 (MapType0Type
- some weird type invariant? (irrelevant? skip?)
- store does not change type?
- Ax1: update
- Ax2: stable
- useless stable axiom? (skip?)



(forall ((arg0@@4 T@U) (arg1@@2 T@U) ) ((let ((aVar1 (MapType0TypeInv1 (type arg0@@4))))
(let ((aVar0 (type arg1@@2)))
 (=> (and (= (type arg0@@4) (MapType0Type aVar0 aVar1)) (= (type arg1@@2) aVar0)) (= (type (MapType0Select arg0@@4 arg1@@2)) aVar1))))))

(forall ((arg0@@5 T@U) (arg1@@3 T@U) (arg2 T@U) ) ((let ((aVar1@@0 (type arg2)))
(let ((aVar0@@0 (type arg1@@3)))
 (=> (and (and (= (type arg0@@5) (MapType0Type aVar0@@0 aVar1@@0)) (= (type arg1@@3) aVar0@@0)) (= (type arg2) aVar1@@0)) (= (type (MapType0Store arg0@@5 arg1@@3 arg2)) (MapType0Type aVar0@@0 aVar1@@0)))))))
