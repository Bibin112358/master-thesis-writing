...
\paragraph{Type Declarations and Abstract Values} 
...
\paragraph{Axioms and Quantifiers}
...
Using the syntax \texttt{var m:[D] R}, one can declare a map with domain type \texttt{D} and codomain (range) type \texttt{R}.
...
Furthermore, the domain and codomain types can themselves be maps, enabling nested map structures.
...
\paragraph{Overall Approach} Proving the complete implementation of the Boogie verifier end-to-end would be a monumental task,
...
\paragraph{Formal Semantics} To achieve this, we must precisely define what it means for a Boogie program to be "correct".
...
To generate this proof, the preceding work instrumented the codebase of the Boogie verifier.
...
The preceding work was built when predicate type encoding was the default,
